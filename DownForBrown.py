...
from sheeeshdatzkrazy import DownForBrown
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.rainbow, '=============[ 𝙻𝙾𝙲𝙰𝚃𝙸𝙾𝙽 ]============='))
    ...
    print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝙼𝙴𝙽𝚄 ]==============='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = DownForBrown(acc_access_key)
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝚂𝙴𝚁𝚅𝙸𝙲𝙴 ]==============='))
            
            service = IntPrompt.ask(f"[bold][?] Select a Service [red][1-{choices[-1]} or 0][/red][/bold]", choices=choices, show_choices=False)
            
            print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙸𝙽𝙶, 𝙿𝙻𝚂 𝚆𝙰𝙸𝚃! ]==============='))
